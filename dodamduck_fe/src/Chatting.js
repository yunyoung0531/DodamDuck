        ...
        <div className="chat-container">
            <div style={{margin: '20px', display: 'flex', flexDirection: 'column'}}>
                <div style={{display: 'flex', justifyContent: 'center'}}>
                    <img src={user?.profile_url || "https://as2.ftcdn.net/v2/jpg/00/64/67/63/1000_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg"}  width={'80px'} height={'80px'} style={{borderRadius: '50%'}}/>
                    ...
                    {chatList.map((chat, index) => (
                        <div className="chat-user-line" key={chat.chat_id || index} onClick={() => goToChatDetail(chat.chat_id, chat.user1_id === user.userID ? chat.user2_id : chat.user1_id, chat.user1_id === user.userID ? chat.user2_name : chat.user1_name, user.userID)}>
                            <div style={{ display: 'flex', marginTop: '7px', marginBottom: '7px' }}>
                                <img src={`http://sy2978.dothome.co.kr/userProfile/user_id_${chat.user1_id === user.userID ? chat.user2_id : chat.user1_id}.jpg` || "https://www.vhv.rs/dpng/d/312-3120300_default-profile-hd-png-download.png"} 
                                width={'72px'} height={'72px'} style={{ borderRadius: '50%' }} 
                                onError={(e) => e.target.src = "https://as2.ftcdn.net/v2/jpg/00/64/67/63/1000_F_64676383_LdbmhiNM6Ypzb3FM4PPuFP9rHe7ri8Ju.jpg"}
                                />
