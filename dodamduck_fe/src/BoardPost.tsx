...
const BoardPost: React.FC = () => {
    ...
    if (existingToken) {
      try {
        const response = await axios.post(
          "http://sy2978.dothome.co.kr/upload_content_share.php",
          formData,
          {
            headers: {
  ...
  return (
    <>
      <div className="sharing-post-comment">도담덕 게시판 글 올리기 🖤</div>
      <div
        style={{
          display: "flex",
      ...
      >
        <div
          ...
          style={{ flexDirection: "column", color: "" }}
        >
          <Form.Control
          ...
          <div style={{ display: "flex" }}>
            <Form.Control
              as="textarea"
              placeholder=" 도담덕 게시판은 누구나 기분 좋게 참여할 수 있는 커뮤니티를 만들기 위해 커뮤니티 이용규칙을 제정하여 운영하고 있습니다. 
